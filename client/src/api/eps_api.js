/**
 * Módulo que contiene funciones para realizar operaciones relacionadas con las Entidades Promotoras de Salud (EPS) mediante peticiones a la API.
 ...
 *
 * @type {Object}
 * @property {Function} get - Función para realizar una solicitud GET para obtener todas las EPS.
 */
...
/**
 * Obtiene todas las Entidades Promotoras de Salud (EPS) disponibles haciendo una solicitud GET a la API.
 *
 * @function
